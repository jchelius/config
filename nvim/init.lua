...
-- custom OpenMarkdownPreview function for OpenMarkdownPreview
-- function OpenMarkdownPreview(url)
--   vim.fn.jobstart({ 'firefox', '--new-window', url }, { silent = true })
-- end
--
        ...
        clangd = {
          ...
          init_options = {
            fallback_flags = {
              ...
              -- '-Wno-sign-conversion',
              -- '-I/usr/local/include',
              -- '-I/usr/lib/gcc/x86_64-pc-linux-gnu/14.2.1/include-fixed',
              -- '-I/usr/include',
            },
          },
        },
